...
MyFaEccTest::MyFaEccTest() {
}

MyFaEccTest::~MyFaEccTest() {
}

void MyFaEccTest::image_jacobian_translation_ECC(const Mat& src1, const Mat& src2, Mat& dst) {
...
void MyFaEccTest::project_onto_jacobian_ECC(const Mat& src1, const Mat& src2, Mat& dst){
    int w;
...
void MyFaEccTest::update_warping_matrix_ECC (Mat& map_matrix, const Mat& update, const int motionType) {
...
double MyFaEccTest::findTransformECC(Mat src, Mat dst, Mat &map, int motionType,
